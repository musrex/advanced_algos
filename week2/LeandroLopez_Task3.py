# Worksheet Task 3
# A method for the AVLTree class that prints out the elements 
# using a depth-first post order tree traversal
# Create a main function to demonstrate your method call and result
